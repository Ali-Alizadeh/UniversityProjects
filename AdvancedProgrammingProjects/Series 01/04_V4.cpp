...
int main()
{
    ...
    char startOfPeriod = pow(10, length - 1), endOfPeriod = pow(10, length), min = endOfPeriod, max = startOfPeriod;
    for (char currentNumber = startOfPeriod; currentNumber < endOfPeriod; currentNumber++)
    {
